...
**This is a fork of [OpenWorker](https://github.com/andrewyng/openworker) with many features added: Linux DEB/AppImage builds, i18n support, multiple Ollama endpoints, optional Ollama API keys, NVIDIA NIM provider and more.**
...
**OpenAI · Anthropic · Google Gemini · BytePlus Ark · Volcengine Ark Agent Plan · Inkling (Thinking Machines) · GLM (Z.ai) · DeepSeek · Kimi (Moonshot) · Qwen · MiniMax · Mistral · Grok (xAI)** - plus open-weight models via **Together**, **Fireworks** and **NVIDIA NIM**, and fully local models via **Ollama**.
