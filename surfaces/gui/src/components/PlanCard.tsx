  ...
  return (
    <div className="dirreq-card plan-card">
      <div className="dirreq-head">
        ...
        <span>{t("planCard.agentProposedPlan")}</span>
      </div>
      ...
      {rejecting ? (
        <div className="dirreq-actions">
          <input
            ...
            placeholder={t("planCard.whatShouldChange")}
            value={feedback}
            autoFocus
